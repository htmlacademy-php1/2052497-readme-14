...
$sql_followers = "SELECT user_id as id FROM subscriptions WHERE follower_id = $user_id";
...
$followers_id_sql = implode(", ", $followers_id);
...
WHERE p.user_id IN ($followers_id_sql)$sql_sort_type
