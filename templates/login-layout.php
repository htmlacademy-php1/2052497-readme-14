        ...
        <section class="authorization">
          ...
          <form class="authorization__form form" action="#" method="post">
            ...
            <div class="form__input-section <?=isset($has_errors['login']) ? 'form__input-section--error' : '';?>">
              <input class="authorization__input authorization__input--login form__input" type="text" name="login" placeholder="Логин"  value="<?=$_POST['login'] ?? NULL;?>">
              <svg class="form__input-icon" width="19" height="18">
                <use xlink:href="#icon-input-user"></use>
              </svg>
              <label class="visually-hidden">Логин</label>
            </div>
              <span class="form__error-label form__error-label--login"><?=$has_errors['login'];?></span>
            </div>
            <div class="authorization__input-wrapper form__input-wrapper">
            <div class="form__input-section <?=isset($has_errors['password']) ? 'form__input-section--error' : '';?>">
              ...
              <span class="form__error-label"><?=$has_errors['password'];?></span>
            </div>
