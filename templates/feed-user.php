        ...
        <section class="feed">
                    ...
                    <article class="feed__post post post-photo">
                        <header class="post__header post__author">
                            <a class="post__author-link" href="profile.php?user=<?=$post['user_id'];?>" title="Автор">
                                <div class="post__avatar-wrapper">
                                    <img class="user__picture" src="<?=$post['avatar'];?>" alt="Аватар пользователя" width="60" height="60">
                                </div>
                        ...
                        <div class="post__main">
                            ...
                            <div class="post-photo__image-wrapper">
                                <img src="<?=$post['photo_content'];?>" alt="Фото от пользователя" width="760" height="396">
                            </div>
                        </div>                        
            ...
            <ul class="feed__filters filters">
                ...
                <?php foreach ($types as $type) : ?>
                    <li class="feed__filters-item filters__item">
                        <a class="filters__button filters__button--<?= $type['type']; ?> button <?= $type['id'] == $get_type_id ? "filters__button--active" : ""; ?>" href="?type=<?= $type['id']; ?>">
