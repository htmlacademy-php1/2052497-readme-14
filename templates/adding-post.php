          ...
          <div class="adding-post__tabs-wrapper tabs">
            <div class="adding-post__tabs filters">
              <ul class="adding-post__tabs-list filters__list tabs__list">
                ...
                <li class="adding-post__tabs-item filters__item">
                  <a class="adding-post__tabs-link filters__button filters__button--<?=$type['type'];?> <?=$type['id'] == $get_type ? 'filters__button--active' : ''; ?> tabs__item tabs__item--active button" href="?id=<?=$type['id'];?>">
            ...
            <div class="adding-post__tab-content"> 
              <section class="adding-post__photo tabs__content tabs__content--active">
                ...
                <form class="adding-post__form form" action="add.php?id=<?=$get_type?>" method="post" enctype="multipart/form-data">
